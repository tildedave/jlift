...
public class JLiftReturnExt extends JifReturnExt {

    public JLiftReturnExt(ToJavaExt toJava) {
        super(toJava);
    }
    ...
    public Node labelCheckStmt(LabelChecker lc) throws SemanticException
    {
        ...
        if (rs.expr() == null) {
            ...
            Label Lr = mi.returnLabel(); //lc.upperBound(mi.returnLabel(), ts.callSitePCLabel(mi));
            Label Lrv = null;
            ...
            JLiftSubtypeChecker subtypeChecker = new JLiftSubtypeChecker(retType, e.type(), null);
